            ...
            <main className="container" style={{ paddingTop: '150px', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh', direction: 'rtl' }}>
                <div className="glass-card animate-fade-in" style={{ width: '100%', maxWidth: '440px', padding: '40px' }}>
                    <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                        ...
                        <h2 className="text-gradient" style={{ fontSize: '1.8rem' }}>تسجيل الدخول</h2>
                        <p style={{ color: 'var(--text-secondary)', marginTop: '8px' }}>أهلاً بعودتك! سجّل دخولك للمتابعة</p>
                    </div>

                    {error && (
                        <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', color: '#f87171', padding: '12px 16px', borderRadius: '12px', marginBottom: '20px', textAlign: 'center', fontSize: '0.95rem' }}>
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '15px' }}>
                            <Link href="/register" style={{ color: 'var(--accent-color)', textDecoration: 'none', fontWeight: '600' }}>ليس لديك حساب؟ أنشئ حساباً جديداً</Link>
                        </div>
                    </form>

                    <div style={{ marginTop: '24px', padding: '16px', background: 'rgba(76,201,240,0.08)', borderRadius: '12px', border: '1px solid rgba(76,201,240,0.15)' }}>
                        <p style={{ color: 'var(--accent-color)', fontSize: '0.85rem', textAlign: 'center' }}>
                            🔑 حساب المدير: admin@store.com / admin
                        </p>
                    </div>
                </div>
            </main>
